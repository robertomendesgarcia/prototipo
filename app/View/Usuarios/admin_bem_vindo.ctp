<table cellspacing="0" cellpadding="0" class="listagem">
    ...
    <tr>
        ...
        <td><?php echo $produto_categorias; ?></td>
        <td><?php echo $produto_categoria_ativos; ?></td>
    ...
    <tr>
        ...
        <td><?php echo $newsletter_ativos; ?></td>
    ...
    <tr>
        ...
        <td><?php echo $usuario_ativos; ?></td>
        <td><?php echo $usuario_ultimo; ?></td>        
    </tr>
</table>