      ...
      <?php foreach ($paginas as $pagina) { ?>
            <tr>
                  ...
                  <td class="acoes_3_botoes">
                        <?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $pagina['Pagina']['id']), array('class' => 'botao')); ?>
                        <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $pagina['Pagina']['id']), array('class' => 'botao'), __('Are you sure you want to delete this page?')); ?>
                  </td>
            </tr>
      <?php }; ?>
</table>