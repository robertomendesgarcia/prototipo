...
<fieldset>
    ...
    <?php echo $this->Form->input('produtos', array('label' => __('I want to have products.'), 'type' => 'checkbox')); ?>
    <?php echo $this->Form->input('noticias', array('label' => __('I want to have news.'), 'type' => 'checkbox')); ?>
    <?php echo $this->Form->input('banners', array('label' => __('I want to have banners.'), 'type' => 'checkbox')); ?>
    <?php echo $this->Form->input('barra_lateral', array('label' => __('I want to have a right sidebar.'), 'type' => 'checkbox')); ?>
    <?php echo $this->Form->input('rodape', array('label' => __('I want to have a footer.'), 'type' => 'checkbox')); ?>
</fieldset>
...
<div class="botoes">
    ...
    <?php echo $this->Form->postLink(__('Cancel'), array('action' => 'index'), array('class' => 'botao'), __('Do you really want to cancel settings?')); ?>
</div>
