...
INSERT INTO `estruturas` (`pin`,	`nome`, 				`created`, 	`modified`,	`usa_barra_lateral`,	`usa_rodape`, 	`cor_fonte_texto`, 	`cor_bg_html`,	`cor_bg_topo`,	`cor_bg_rodape`, 	`img_bg_html_repeat`, 	`posicao_menu`,	`menu_degade`,	`cor_bg_menu`, `cor_fonte_menu`,	`mostrar_noticias_capa`,	`qtde_noticias_capa`,	`mostrar_noticias_lateral`,	`qtde_noticias_lateral`,	`mostrar_produtos_capa`,	`qtde_produtos_capa`,	`mostrar_produtos_lateral`,	`qtde_produtos_lateral`,	`img_bg_html`,								`img_logo`,	`cor_titulo`,	`img_bg_topo`, `keywords`,	`description`,	`author`,	`tamanho_centro`,	`telefone`)
				VALUES ('ep_01',	'Estrutura Padrão 01', 	NOW(), 		NOW(), 		'1', 					'1', 			'#333333', 			'#FFFFFF', 		'#FFFFFF',		'#FFFFFF', 			'repeat-x', 			'1', 			'0', 			'#444444', 		'#FFFFFF',			'1',						'5',					'1',						'3',						'1',						'5',					'1',						'3',						'img/layouts_padroes/ep_01/bg_html.png',	NULL,		'#777777',		NULL,			NULL,		NULL,			NULL,		'medio',			NULL);
